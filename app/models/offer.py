...
class Offer(Base):
    ...
    offer_type: Mapped[str | None] = mapped_column(String(255), nullable=True)

    # Value and currency
    value: Mapped[float | None] = mapped_column(Numeric(precision=10, scale=2), nullable=True)
    ...
    terms: Mapped[dict[str, Any] | None] = mapped_column(json_type, nullable=True)
